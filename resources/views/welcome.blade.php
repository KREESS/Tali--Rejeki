...
@section('content')
  ...
  /* Hero Section */
    ...
    .btn{
      ...
      /* Menghilangkan border biru default browser */
      box-shadow: none !important;
      border: none !important;
    }
    .btn-primary{background:linear-gradient(135deg,#dc2626,#f87171);color:#fff;box-shadow:0 10px 30px rgba(220,38,38,.32);border:2px solid transparent !important;}
    .btn-primary:hover{transform:translateY(-2px);box-shadow:0 14px 36px rgba(220,38,38,.42);border-color:#fff !important;color:#fff;}
    .btn-primary:focus,.btn-primary:focus-visible{outline:none !important;box-shadow:0 0 0 3px var(--ring-hero), 0 12px 34px rgba(220,38,38,.40) !important;border-color:#fff !important;}
    .btn-outline{background:transparent;color:#fff;border:2px solid rgba(255,255,255,.6) !important;}
    .btn-outline:hover{background:rgba(255,255,255,.15);border-color:#dc2626 !important;color:#dc2626;transform:translateY(-2px);}
    .btn:focus,.btn:focus-visible{outline:none !important;box-shadow:0 0 0 3px var(--ring-hero-soft), 0 10px 28px rgba(0,0,0,.25) !important;}
    .btn-primary:focus-visible{box-shadow:0 0 0 3px var(--ring-hero), 0 12px 34px rgba(220,38,38,.40) !important;}
    .btn-outline:focus-visible{border-color:rgba(255,255,255,.9) !important;box-shadow:0 0 0 3px var(--ring-hero-soft) !important;}
    ...
    .hero-prev:focus-visible,.hero-next:focus-visible{outline:none;box-shadow:0 0 0 3px var(--ring-hero) !important;}

    /* Dots */
    .hero-dots{position:absolute;left:50%;transform:translateX(-50%);bottom:22px;display:flex;gap:8px;z-index:2;}
    .hero-dots .dot{width:10px;height:10px;border-radius:999px;background:rgba(255,255,255,.45);border:none;cursor:pointer;transition:.2s ease;padding:0;box-shadow: none !important;}
    .hero-dots .dot.is-active{width:26px;border-radius:8px;background:#dc2626;}
    .hero-dots .dot:focus-visible{outline:none;box-shadow:0 0 0 3px var(--ring-hero) !important;}
  ...
  /* ===== CTA Section ===== */
    ...
    .cta-actions .btn {
        ...
        text-decoration: none;
        min-width: 200px;
        /* Mengatasi border dari Bootstrap */
        border: none;
        outline: none;
        box-shadow: none;
    }
    ...
    .cta-actions .btn:hover {
        /* Menghilangkan border dan outline saat fokus, aktif, atau hover */
