...
<div class="map-section position-relative" style="height: 50vh;" data-aos="fade-in" data-aos-duration="1000">
    ...
    <div class="map-controls position-absolute top-0 start-0 m-4" style="z-index: 10;" data-aos="slide-right" data-aos-delay="200">
        <div class="btn-group shadow-lg" role="group">
            <button class="btn map-control-btn" onclick="openMapsApp()" title="Open in Google Maps">
                <i class="fas fa-external-link-alt"></i>
            </button>
            <button class="btn map-control-btn" onclick="copyCoordinates()" title="Copy Coordinates">
                <i class="fas fa-copy"></i>
            </button>
            <button class="btn map-control-btn" onclick="getDirections()" title="Get Directions">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="map-badges d-flex gap-2">
                        ...
                        <span class="badge map-badge">
                            <i class="fas fa-phone me-1"></i>Available
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="hero-content" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <p class="hero-description mb-4 lh-base" data-aos="fade-up" data-aos-delay="600">
                        Find our location and get in touch with PT. Tali Rejeki for your needs. 
                        We are ready to serve with full dedication and high professionalism.
                    </p>
                    <div class="hero-actions d-flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <a href="https://wa.me/6281382523722?text=Hello,%20I%20want%20to%20inquire%20about%20PT.%20Tali%20Rejeki%20products" 
                           target="_blank" 
                    ...
                    <div class="hero-stats mt-4 d-flex flex-wrap gap-3" data-aos="fade-up" data-aos-delay="800">
                        <div class="stat-item" data-aos="zoom-in" data-aos-delay="900">
                            <div class="stat-number fw-bold">Mon-Fri</div>
                        ...
                        <div class="stat-item" data-aos="zoom-in" data-aos-delay="1000">
                            ...
                            <div class="stat-label small">Years of Experience</div>
                        </div>
                        <div class="stat-item" data-aos="zoom-in" data-aos-delay="1100">
                            <div class="stat-number fw-bold">1000+</div>
                            <div class="stat-label small">Satisfied Clients</div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="contact-section py-5" id="contact-info">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up" data-aos-duration="800">
            <h2 class="section-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="200">Contact Information</h2>
            <p class="section-subtitle" data-aos="fade-up" data-aos-delay="300">Various ways to get in touch with us</p>
                    ...
                    <div class="contact-grid row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="contact-info-item address-card h-100" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="info-content">
                                    <h5 class="info-title mb-3" data-aos="fade-up" data-aos-delay="800">Full Address</h5>
                        ...
                        <div class="col-md-6">
                            <div class="contact-info-item coordinates-card h-100" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="info-content">
                                    <h5 class="info-title mb-3" data-aos="fade-up" data-aos-delay="900">GPS Coordinates</h5>
                        ...
                        <div class="col-md-6">
                            <div class="contact-info-item contact-methods-card h-100" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="info-content">
                                    <h5 class="info-title mb-3" data-aos="fade-up" data-aos-delay="1000">Contact Us</h5>
                                    <div class="contact-methods" data-aos="fade-up" data-aos-delay="1100">
                                        <div class="contact-method">
                                            ...
                                            <span class="method-status online">Available</span>
                                        </div>
                                        <div class="contact-method">
                                            <i class="method-icon fas fa-phone-alt"></i>
                        ...
                        <div class="col-md-6">
                            <div class="contact-info-item hours-card h-100" data-aos="fade-up" data-aos-delay="800">
                                ...
                                <div class="info-content">
                                    <h5 class="info-title mb-3" data-aos="fade-up" data-aos-delay="1100">Operating Hours</h5>
                                    ...
                                    <div class="current-status mt-3" data-aos="fade-up" data-aos-delay="1300">
                                        <span class="status-badge open">
                                            <i class="fas fa-circle me-2"></i>Normal Working Hours
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="contact-form-card glass-card h-100 p-4" data-aos="fade-left" data-aos-delay="300">
                    <div class="form-header text-center mb-4" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <h4 class="form-title mb-2" data-aos="fade-up" data-aos-delay="800">Send a Message</h4>
                        <p class="form-subtitle" data-aos="fade-up" data-aos-delay="900">We will respond within 24 hours</p>
                    </div>
                    
                    <form class="contact-form" id="contactForm">
                        <div class="form-floating mb-3" data-aos="fade-up" data-aos-delay="1000">
                            <input type="text" class="form-control modern-input" id="name" required placeholder="Full Name">
                        ...
                        <div class="form-floating mb-3" data-aos="fade-up" data-aos-delay="1200">
                            <input type="tel" class="form-control modern-input" id="phone" placeholder="Phone Number">
                        ...
                        <div class="form-floating mb-4" data-aos="fade-up" data-aos-delay="1400">
                            <textarea class="form-control modern-input" id="message" rows="4" required placeholder="Your Message" style="height: 120px;"></textarea>
...
<div class="quick-actions-section py-5">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up" data-aos-duration="800">
            <h2 class="section-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="200">Easy Ways to Contact Us</h2>
            <p class="section-subtitle" data-aos="fade-up" data-aos-delay="300">Choose the method that’s most convenient for you</p>
            <div class="section-divider mx-auto" data-aos="zoom-in" data-aos-delay="400"></div>
        </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="action-card glass-card h-100 text-center p-4 position-relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="action-content position-relative">
                        ...
                        <h5 class="action-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="500">Directions</h5>
                        <p class="action-description mb-4" data-aos="fade-up" data-aos-delay="600">Get the fastest route to our location via Google Maps</p>
                        <button onclick="getDirections()" class="btn action-btn directions-btn px-4 py-2" data-aos="fade-up" data-aos-delay="700">
                            <i class="fas fa-external-link-alt me-2"></i>Open Maps
                        </button>
                        <div class="action-stats mt-3" data-aos="fade-up" data-aos-delay="800">
                            <small class="stat-text">
                                <i class="fas fa-clock me-1"></i>±45 minutes from Jakarta
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="action-card glass-card h-100 text-center p-4 position-relative overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="action-content position-relative">
                        ...
                        <p class="action-description mb-4" data-aos="fade-up" data-aos-delay="700">Chat directly with our marketing team</p>
                        ...
                        <div class="action-stats mt-3" data-aos="fade-up" data-aos-delay="900">
                            <small class="stat-text">
                                <i class="fas fa-user me-1"></i>Marketing Team Available
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="action-card glass-card h-100 text-center p-4 position-relative overflow-hidden" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="action-content position-relative">
                        ...
                        <p class="action-description mb-4" data-aos="fade-up" data-aos-delay="800">Send an email for detailed inquiries and special offers</p>
                        <a href="mailto:talirejeki@gmail.com?subject=Inquiry%20about%20Products&body=Hello%20PT.%20Tali%20Rejeki,%0A%0AI would like to ask about..." class="btn action-btn email-btn px-4 py-2" data-aos="fade-up" data-aos-delay="900">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="action-card glass-card h-100 text-center p-4 position-relative overflow-hidden" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="action-content position-relative">
                        ...
                        <h5 class="action-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="800">Call</h5>
                        <p class="action-description mb-4" data-aos="fade-up" data-aos-delay="900">Call directly for consultation and product information</p>
                        ...
                        <div class="action-stats mt-3" data-aos="fade-up" data-aos-delay="1100">
                            <small class="stat-text">
                                <i class="fas fa-user-headset me-1"></i>Team Ready to Assist
                            </small>
                        </div>
                    </div>
                </div>
...
<div class="contact-persons-section py-5">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up" data-aos-duration="800">
            <h2 class="section-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="200">Our Marketing Team</h2>
            <p class="section-subtitle" data-aos="fade-up" data-aos-delay="300">Contact our marketing team directly for your needs</p>
            <div class="section-divider mx-auto" data-aos="zoom-in" data-aos-delay="400"></div>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-6">
                <div class="person-card glass-card text-center p-4 h-100" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="https://wa.me/6281382523722?text=Hello%20Siti,%20I%20would%20like%20to%20inquire%20about%20PT.%20Tali%20Rejeki%20products" target="_blank" rel="noopener" class="btn btn-whatsapp w-100 mb-2" data-aos="fade-up" data-aos-delay="700">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="person-card glass-card text-center p-4 h-100" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <a href="https://wa.me/6281384808218?text=Hello%20Kurnia,%20I%20would%20like%20to%20inquire%20about%20PT.%20Tali%20Rejeki%20products" target="_blank" rel="noopener" class="btn btn-whatsapp w-100 mb-2" data-aos="fade-up" data-aos-delay="800">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="person-card glass-card text-center p-4 h-100" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <a href="https://wa.me/6281385231149?text=Hello%20Yovien,%20I%20would%20like%20to%20inquire%20about%20PT.%20Tali%20Rejeki%20products" target="_blank" rel="noopener" class="btn btn-whatsapp w-100 mb-2" data-aos="fade-up" data-aos-delay="900">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="person-card glass-card text-center p-4 h-100" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <a href="https://wa.me/6281514515990?text=Hello%20Edy,%20I%20would%20like%20to%20inquire%20about%20PT.%20Tali%20Rejeki%20products" target="_blank" rel="noopener" class="btn btn-whatsapp w-100 mb-2" data-aos="fade-up" data-aos-delay="1000">
...
<div class="features-section py-5">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up" data-aos-delay="100">
            <h2 class="section-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="200">Why Choose PT. Tali Rejeki?</h2>
            <p class="section-subtitle" data-aos="fade-up" data-aos-delay="300">Our commitment to providing the best service</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card glass-card text-center p-5 h-100 position-relative" data-aos="flip-left" data-aos-delay="200">
                    ...
                    <div class="feature-content position-relative">
                        ...
                        <h4 class="feature-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="500">Guaranteed Quality</h4>
                        <p class="feature-description mb-4" data-aos="fade-up" data-aos-delay="600">High-quality products with internationally tested and certified standards</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card glass-card text-center p-5 h-100 position-relative" data-aos="flip-left" data-aos-delay="400">
                    ...
                    <div class="feature-content position-relative">
                        ...
                        <h4 class="feature-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="700">Fast Delivery</h4>
                        <p class="feature-description mb-4" data-aos="fade-up" data-aos-delay="800">Express delivery service across Indonesia with guaranteed safety and punctuality</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card glass-card text-center p-5 h-100 position-relative" data-aos="flip-left" data-aos-delay="600">
                    ...
                    <div class="feature-content position-relative">
                        ...
                        <h4 class="feature-title fw-bold mb-3" data-aos="fade-up" data-aos-delay="900">24/7 Customer Service</h4>
                        <p class="feature-description mb-4" data-aos="fade-up" data-aos-delay="1000">Professional customer service team ready to assist you with quick responses and the best solutions</p>
                        ...
                        <div class="feature-metrics" data-aos="fade-up" data-aos-delay="1200">
                            <div class="metric">
                                ...
                                <span class="metric-label">Response Minutes</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="mini-feature-card glass-card p-4 h-100" data-aos="slide-right" data-aos-delay="300">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mini-feature-title fw-semibold mb-2" data-aos="fade-up" data-aos-delay="600">Product Warranty</h6>
                            <p class="mini-feature-text mb-0" data-aos="fade-up" data-aos-delay="700">Official warranty guarantee for all products we sell</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mini-feature-card glass-card p-4 h-100" data-aos="slide-left" data-aos-delay="500">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mini-feature-text mb-0" data-aos="fade-up" data-aos-delay="900">Trusted by 1000+ companies across Indonesia</p>
                        </div>
                    </div>
                </div>
            </div>
