            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="header-content" data-aos="fade-up">
                    ...
                    <h1 class="page-title" data-aos="fade-up" data-aos-delay="600">
                        <span class="title-main" data-aos="fade-right" data-aos-delay="700">Careers</span>
                        <span class="title-highlight" data-aos="fade-left" data-aos-delay="800">With Us</span>
                    </h1>
                    <p class="page-description" data-aos="fade-up" data-aos-delay="900">
                        Join our professional team and build a bright career in the leading insulation industry. 
                        Unlock your full potential with Tali Rejeki.
                    </p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="culture-content">
                    ...
                    <h2 class="section-title" data-aos="fade-up" data-aos-delay="400">Why Join Tali Rejeki?</h2>
                    <p class="section-description" data-aos="fade-up" data-aos-delay="500">
                        We believe that human resources are the company's most valuable asset. Join a work environment 
                        that supports personal growth and provides opportunities for every individual to thrive.
                    </p>
                    ...
                    <div class="culture-features">
                        <div class="feature-item" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Continuous training programs and clear career paths for a bright future</p>
                        ...
                        <div class="feature-item" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Maintaining a healthy work-life balance for optimal productivity</p>
                                <div class="feature-progress">
                        ...
                        <div class="feature-item" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="feature-content">
                                <h4>Strong Team</h4>
                                <p>A collaborative and supportive work environment to achieve shared goals</p>
                                <div class="feature-progress">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="culture-visual">
                    <div class="image-container">
                        <img src="{{ asset('img/career/104.png') }}" alt="Company Culture" class="img-fluid rounded-3">
...
<section class="benefits-section py-5">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="section-title" data-aos="fade-up" data-aos-delay="300">Compensation & Benefits Package</h2>
            <p class="section-description" data-aos="fade-up" data-aos-delay="400">
                We provide competitive compensation packages and various attractive benefits to support employee well-being
            </p>
        </div>
        ...
        <div class="row g-4 stagger-children" data-aos="fade-up" data-aos-delay="500">
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="benefit-card premium-card">
                    ...
                    <h3 class="benefit-title">Competitive Salary</h3>
                    <p class="benefit-description">
                        Fair and competitive remuneration according to industry and performance, plus annual bonuses
                    </p>
            ...
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="benefit-card health-card">
                    ...
                    <p class="benefit-description">
                        Health coverage for employees and families with comprehensive plans and premium services
                    </p>
            ...
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="benefit-card vacation-card">
                    ...
                    <h3 class="benefit-title">Leave & Vacation</h3>
                    <p class="benefit-description">
                        Annual leave, sick leave, and flexible leave options for optimal work-life balance
                    </p>
            ...
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="benefit-card training-card">
                    ...
                    <p class="benefit-description">
                        Internal and external training programs to enhance skills and professional certifications
                    </p>
            ...
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="benefit-card bonus-card">
                    ...
                    <h3 class="benefit-title">Bonuses & Incentives</h3>
                    <p class="benefit-description">
                        Performance-based bonuses and incentives for achieving specific targets with attractive rewards
                    </p>
            ...
            <div class="col-12 col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div class="benefit-card flexibility-card">
                    ...
                    <p class="benefit-description">
                        Flexible working hours and work-from-home options for certain positions with advanced technology
                    </p>
...
<section class="jobs-section py-5" id="jobs">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="section-title" data-aos="fade-up" data-aos-delay="300">Available Positions</h2>
            <p class="section-description" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="jobs-grid">
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-4 mb-4 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                    <div class="job-card h-100 w-100">
                        ...
                        <div class="job-content">
                            <p class="job-description">{{ Str::limit($job->summary ?? 'Description will be updated soon.', 120) }}</p>
...
<section class="recruitment-process py-5">
    <div class="container">
        <div class="section-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="section-title" data-aos="fade-up" data-aos-delay="300">Application Steps</h2>
            <p class="section-description" data-aos="fade-up" data-aos-delay="400">
                A transparent and professional recruitment process to ensure the best candidates
            </p>
        </div>
        ...
        <div class="process-steps" data-aos="fade-up">
            <div class="step-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4>Application</h4>
                <p>Submit your CV and cover letter via online form or email</p>
            </div>
            ...
            <div class="step-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <h4>Screening</h4>
                <p>The HR team will review your documents and perform initial screening</p>
            </div>
            ...
            <div class="step-item" data-aos="fade-up" data-aos-delay="300">
                ...
                <h4>Interview</h4>
                <p>Interview with HR and relevant team to get to know you better</p>
            </div>
            ...
            <div class="step-item" data-aos="fade-up" data-aos-delay="400">
                ...
                <h4>Assessment</h4>
                <p>Skills and psychological tests according to the applied position</p>
            </div>
            ...
            <div class="step-item" data-aos="fade-up" data-aos-delay="500">
                ...
                <h4>Offer</h4>
                <p>Job offer and compensation package negotiation</p>
            </div>
        </div>
    </div>
</section>
...
<section class="cta-section py-5" data-aos="fade-up" data-aos-delay="100">
    <div class="container">
        <div class="cta-content text-center" data-aos="zoom-in" data-aos-delay="300">
            ...
            <h2 class="cta-title" data-aos="fade-up" data-aos-delay="600">Ready to Start Your Career With Us?</h2>
            <p class="cta-description" data-aos="fade-up" data-aos-delay="700">
                Don’t miss the opportunity to be part of an innovative and dedicated team. 
                Begin your career journey with Tali Rejeki!
            </p>
...
/* Jobs Section Enhanced Responsive */
.jobs-section {
    padding: 100px 0;
    background: transparent;
    position: relative;
