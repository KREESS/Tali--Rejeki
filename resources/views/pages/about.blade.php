...
<section class="u-stats bg-photo py-5" data-ustats-scope="home-stats-01"
         style="--u-photo:url('/img/galeri-proyek/3.jpg'); /* Laravel public/ → /img/... */
                --u-photo-pos:center 38%;                 /* atur posisi fokus foto di sini */
                --u-photo-attach:auto;                    /* auto | fixed (desktop di CSS juga diatur) */">
  <div class="container">
    <div class="row text-center">
      <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
        <div class="u-stat-item">
          ...
          <div class="u-stat-label">Tahun Pengalaman</div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
        <div class="u-stat-item">
          ...
          <div class="u-stat-label">Proyek Selesai</div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
        <div class="u-stat-item">
          ...
          <div class="u-stat-label">Klien Aktif</div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
        <div class="u-stat-item">
          ...
          <div class="u-stat-label">Kota Terjangkau</div>
        </div>
      </div>
    </div>
  </div>
...
<section class="leadership-section py-5">
  <div class="container">
    <div class="section-header text-center mb-5" data-aos="fade-up">
      ...
      <p class="section-description">
        Pimpinan berpengalaman yang memandu strategi dan eksekusi untuk menghadirkan solusi terbaik
      </p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
        <div class="leader-card">
          <div class="leader-image is-fit">
            <img src="{{ asset('img/about/gg11.png') }}" alt="Direktur Utama" class="img-fluid">
          ...
          <div class="leader-content">
            ...
            <p class="leader-position">Direktur Utama (CEO)</p>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div class="leader-card">
          <div class="leader-image is-fit">
            <img src="{{ asset('img/about/gg11.png') }}" alt="Manajer Teknis" class="img-fluid">
            <div class="leader-overlay">
              <div class="leader-social">
                <a href="#" class="social-link"><i class="fab fa-linkedin"></i></a>
                <a href="#" class="social-link"><i class="fas fa-envelope"></i></a>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div class="leader-card">
          <div class="leader-image is-fit">
            <img src="{{ asset('img/about/gg11.png') }}" alt="Manajer Penjualan" class="img-fluid">
            <div class="leader-overlay">
              <div class="leader-social">
                <a href="#" class="social-link"><i class="fab fa-linkedin"></i></a>
                <a href="#" class="social-link"><i class="fas fa-envelope"></i></a>
