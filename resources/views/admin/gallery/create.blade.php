...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-lg-10">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0 opacity-85 fs-6">
                                    ...
                                    Buat galeri foto baru yang menakjubkan
                                </p>
                            </div>
                        </div>
            ...
            <!-- Form -->
            <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data" id="galleryCreateForm">
                @csrf
                            ...
                            <div class="card-body p-4">
                                <div class="row g-4">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-2 rounded-3 modern-input @error('title') is-invalid @enderror" 
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control border-2 rounded-3 modern-input @error('slug') is-invalid @enderror" 
                                               id="slug" name="slug" value="{{ old('slug') }}" 
                                               placeholder="otomatis dari judul (opsional)">
                                        <div class="form-text">
                                            <i class="fas fa-info-circle me-1 text-crimson"></i>
                                            URL akan menjadi: <span class="text-crimson fw-bold" id="urlPreview">{{ url('/gallery') }}/slug-gallery</span>
                                        </div>
                                        @error('slug')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control border-2 rounded-3 modern-input @error('description') is-invalid @enderror" 
                                                  id="description" name="description" rows="4" 
                                                  placeholder="Ceritakan tentang gallery ini...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select form-select-lg border-2 rounded-3 modern-input @error('status') is-invalid @enderror" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="datetime-local" class="form-control border-2 rounded-3 modern-input @error('published_at') is-invalid @enderror" 
                        ...
                        <div class="card shadow-lg border-0 rounded-4 modern-card">
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control border-2 rounded-3 modern-input @error('meta_title') is-invalid @enderror" 
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control border-2 rounded-3 modern-input @error('meta_description') is-invalid @enderror" 
                                              id="meta_description" name="meta_description" rows="3" 
                                              placeholder="Deskripsi untuk search engine" maxlength="255">{{ old('meta_description') }}</textarea>
                                    <div class="form-text">
                                        <i class="fas fa-lightbulb me-1 text-warning"></i>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select border-2 rounded-3 modern-input @error('meta_robots') is-invalid @enderror" 
                                            id="meta_robots" name="meta_robots">
                                        <option value="">🔍 Default (index, follow)</option>
                                        <option value="noindex" {{ old('meta_robots') === 'noindex' ? 'selected' : '' }}>🚫 No Index</option>
                                        <option value="nofollow" {{ old('meta_robots') === 'nofollow' ? 'selected' : '' }}>🔗 No Follow</option>
                                        <option value="noindex,nofollow" {{ old('meta_robots') === 'noindex,nofollow' ? 'selected' : '' }}>❌ No Index, No Follow</option>
                                    </select>
                                    @error('meta_robots')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="url" class="form-control border-2 rounded-3 modern-input @error('canonical_url') is-invalid @enderror" 
                    ...
                    <div class="col-12">
                        <div class="card shadow-lg border-0 rounded-4 modern-card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <input type="file" class="d-none @error('images.*') is-invalid @enderror" id="images" name="images[]" multiple accept="image/*">
                    ...
                    <div class="col-12">
                        <div class="submit-section text-center">
                            <div class="action-buttons d-flex justify-content-center gap-3 flex-wrap">
                                <button type="submit" class="btn btn-crimson btn-lg px-5 rounded-pill shadow-lg modern-btn" id="createBtn">
                                    <div class="btn-content">
                                        <i class="fas fa-save me-2"></i>
                                        <span id="btnText">Simpan Gallery</span>
                                    </div>
...
@push('styles')
<style>
/* Modern Crimson Gallery Create Styling */
:root {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-generate slug from title with URL preview
    if (titleInput && slugInput && urlPreview) {
        titleInput.addEventListener('input', function() {
            if (autoSlug) {
                ...
                // Update URL preview with animation
                const newUrl = slug ? `{{ url('/gallery') }}/${slug}` : '{{ url('/gallery') }}/slug-gallery';
                urlPreview.textContent = newUrl;
                urlPreview.classList.add('url-updated');
                setTimeout(() => urlPreview.classList.remove('url-updated'), 500);
            }
        });
        ...
        slugInput.addEventListener('input', function() {
            if (this.value.trim() !== '') {
                ...
                // Update URL preview
                const newUrl = this.value ? `{{ url('/gallery') }}/${this.value}` : '{{ url('/gallery') }}/slug-gallery';
                urlPreview.textContent = newUrl;
                urlPreview.classList.add('url-updated');
                setTimeout(() => urlPreview.classList.remove('url-updated'), 500);
            } else {
    ...
    // File upload handling with modern features
    ...
    // Modern form submission with enhanced loading
    if (form && createBtn) {
        form.addEventListener('submit', function(e) {
            ...
            showNotification('Sedang memproses pembuatan gallery...', 'info', 0);
        });
    }
    ...
    function updateFileCount() {
        if (fileCount) {
            ...
            fileCount.classList.add('file-count-updated');
            setTimeout(() => fileCount.classList.remove('file-count-updated'), 500);
        }
    }
