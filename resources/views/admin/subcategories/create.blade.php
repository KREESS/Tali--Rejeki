    ...
    <div class="page-header-content">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 opacity-75" style="font-size: 0.85rem;">Membuat sub kategori produk baru untuk Tali Rejeki</p>
            </div>
    ...
    <div class="col-lg-8">
        <div class="premium-form">
            <div class="card-body p-4">
                <form action="{{ route('admin.subcategories.store') }}" method="POST" id="subcategoryForm">
                    @csrf
    ...
    <div class="col-lg-4">
        ...
        <div class="preview-section">
            ...
            <div class="mb-2" style="font-size: 0.85rem;">
                ...
                <div id="previewCategory" class="category-preview">-</div>
            </div>
            
            <div class="mb-2" style="font-size: 0.85rem;">
                <strong>Nama Sub Kategori:</strong>
                <div id="previewName" class="text-muted">-</div>
            </div>
            
            <div class="mb-2" style="font-size: 0.85rem;">
                <strong>Slug URL:</strong>
                <div id="previewSlug" class="text-muted">-</div>
            </div>
            
            <div class="mb-2" style="font-size: 0.85rem;">
                <strong>Meta Title:</strong>
                <div id="previewMetaTitle" class="text-muted">-</div>
            </div>
            
            <div class="mb-0" style="font-size: 0.85rem;">
                <strong>Meta Description:</strong>
                <div id="previewMetaDesc" class="text-muted">-</div>
            </div>
        </div>

        <!-- Category Info -->
        <div class="preview-section mt-3" id="categoryInfo" style="display: none;">
            <h6 class="preview-title">
                <i class="fas fa-folder me-2"></i>
                Info Kategori Induk
            </h6>
            <div id="categoryDetails" style="font-size: 0.85rem;">
        ...
        <div class="preview-section mt-3">
            ...
            <ul class="list-unstyled mb-0" style="font-size: 0.75rem;">
                <li class="mb-1">
                    ...
                    <small>Pilih kategori induk yang sesuai</small>
                </li>
                <li class="mb-1">
                    <i class="fas fa-check text-success me-2"></i>
                    <small>Gunakan nama yang spesifik dan jelas</small>
                </li>
                <li class="mb-1">
                    <i class="fas fa-check text-success me-2"></i>
                    <small>Meta title optimal 50-60 karakter</small>
                </li>
                <li class="mb-1">
                    <i class="fas fa-check text-success me-2"></i>
                    <small>Meta description optimal 150-160 karakter</small>
                </li>
                <li>
                    <i class="fas fa-check text-success me-2"></i>
                    <small>Slug akan dibuat otomatis</small>
                </li>
            </ul>
        </div>
    </div>
...
function updatePreview() {
    ...
    if (categoryId && categoryData[categoryId]) {
        ...
        categoryDetails.innerHTML = `
            <div class="mb-2"><strong>Slug:</strong> <code>${categoryData[categoryId].slug}</code></div>
            <div class="mb-2"><strong>Sub Kategori:</strong> ${categoryData[categoryId].subcategories_count}</div>
            <div><strong>Dibuat:</strong> ${categoryData[categoryId].created_at}</div>
        `;
    } else {
